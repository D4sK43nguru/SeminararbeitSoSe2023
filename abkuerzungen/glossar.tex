...
\newglossaryentry{X509}{
        name = {X.509},
        description = {Standard der \ac{ITUT} für eine \gls{publicKey}-Infrastruktur zum erstellen digitaler Zertifikate. Im November 2020 als ISO/IEC 9594\endash 8 aktualisiert worden}
}
...
\newglossaryentry{authentifizierung}{
        ...
        description = {Der Prozess der Überprüfung der Identit\"at eines \gls{client}s, Gerätes oder Systems, um sicherzustellen, dass sie tatsächlich diejenige Partei sind, für die sie sich ausgeben}
}
