...
\newglossaryentry{X509}{
        name = {X.509},
        description = {Standard der \ac{ITUT} für eine \gls{publicKey}-Infrastruktur zum erstellen digitaler Zertifikate (\autoref{subsubsec:digitale-signaturen-und-zertifikate}). Im November 2020 als ISO/IEC 9594\endash 8 aktualisiert worden}
}
