...
\newglossaryentry{publicKey}{
	name = {Public Key},
	description = {Ein öffentlich zugänglicher \glsdisp{kryptografie}{kryptografischer} Schlüssel, der zur Verschlüsselung und Verifizierung verwendet wird}
}
...
\newglossaryentry{X509}{
        name = {X.509},
        description = {Standard der Internationalen Fernmeldeunion \string(\acs{ITUT}\string) für eine \glspl{publicKey}-Infrastruktur zum erstellen digitaler Zertifikate . Im November 2020 als ISO/IEC 9594--8 aktualisiert worden}
}
