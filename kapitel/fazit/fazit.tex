...
Mithilfe einer ausgiebigen Literaturanalyse konnten dafür verschiedene \glsdisp{kryptografie}{kryptografische}\index{kryptografie} \glspl{algorithmus} untersucht und daraus gebildete Techniken analysiert werden.
...
Die Analyse der verschiedenen \glsdisp{kryptografie}{kryptografischen}\index{kryptografie} Methoden im Zusammenhang mit den Problemen und Hindernissen, die diese auslösen, zeigt, dass es schwierig ist, eine Webanwendung ausgiebig zu sichern.
...
Das Ziel dieser Arbeit, den Nutzen verschiedener \glsdisp{kryptografie}{kryptografischer}\index{kryptografie} Methoden vor- und ihre Auswirkungen darzustellen, wurde somit erreicht.
