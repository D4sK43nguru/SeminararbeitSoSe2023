...
Mithilfe dieser Handshakes wird ausgehandelt, welche \glsdisp{kryptographie}{kryptographischen} \glspl{algorithmus} und Schlüssel verwendet werden und die Kommunikationspartner werden identifiziert und \glsdisp{authentifizierung}{authentifiziert}, wobei es üblich ist, dass sich nur der Server bei dem Client \glsdisp{authentifizierung}{authentifiziert}, was als one-way authentication bezeichnet wird\autocite[\vglf][\pagef 191]{morrissey_tls_2010}.
