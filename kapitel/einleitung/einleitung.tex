...
Dabei wird versucht, die Forschungsfrage \enquote{Wie sehr tragen die aktuell genutzten \glsdisp{kryptografie}{Kryptografischen} Methoden zur Sicherheit von Daten in Webanwendungen bei?} anhand einer Literaturanalyse zu beantworten.


\subsection{Aufbau der Arbeit}\label{subsec:aufbau-der-arbeit}
Dafür werden zunächst ein paar Grundbegriffe und grundlegende Konzepte der \gls{kryptografie} erklärt, sowie verschiedene \glsdisp{kryptografie}{Kryptografische} Verfahren und \glsdisp{algorithmus} dargestellt.
