...
\subsection{Aufbau der Arbeit}\label{subsec:aufbau-der-arbeit}
 \autoref{sec:grundlagen-der-kryptografie} erklärt einige grundlegende Konzepte der \gls{kryptografie}, und stellt verschiedene \glsdisp{kryptografie}{kryptografische} Verfahren und \glspl{algorithmus} dar.
